...
`WebMCP-org/agent-skills-ts-sdk`

## Required Repository Settings

- Branch protection on `main`.
- Required checks for CI, package integrity, CodeQL, and Dependency Review.
- Required CODEOWNER review for governance, package, CI, and release files.
- GitHub private vulnerability reporting enabled.
- Secret scanning and push protection enabled.
- Dependabot security updates enabled.
- GitHub Actions repository variable `RELEASE_REPOSITORY` set to `WebMCP-org/agent-skills-ts-sdk`.
...
- Owner/repository: `WebMCP-org/agent-skills-ts-sdk`
- Workflow filename: `.github/workflows/release.yml`
- Environment: `npm-publish`

The release workflow uses GitHub OIDC and npm provenance. Do not add an
`NPM_TOKEN` for normal public package publishing.
...
installs the packed tarball in a temporary TypeScript consumer project.
