...
- Confirm `WebMCP-org/agent-skills-ts-sdk` is the canonical repository.
- Enable private vulnerability reporting.
- Enable secret scanning and push protection.
- Enable Dependabot security updates.
- Protect `main` with required CI, package integrity, CodeQL, and Dependency Review checks.
...
- Remove or intentionally document any root-level generated artifacts and local-only notes.
